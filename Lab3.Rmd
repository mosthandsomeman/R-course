...
4. Add the difference of goals, and an indicator variable called `goleada` for when the difference of goals is large (>5),  and select what we did only for Brazil. **Hint: use `ifelse`**.
```{r}
